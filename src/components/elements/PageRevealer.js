...
import BaffleText from '../../components/elements/baffle-text'
import AnimationContainer from '../../components/elements/animation-container'
...
class PageRevealer extends React.Component {
    ...
    reveal() {
        if (!this.state.complete) {
            ...
            setTimeout(() => {
                document.getElementById("site").style.backgroundColor = "transparent"
                setTimeout(() => {
