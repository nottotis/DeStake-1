...
class Economics extends React.Component {
  ...
  render() {
    ...
    const sectionHeader = {
      title: 'Provide Liquidity, Earn STAKE',
      paragraph: ''
    };
            ...
            <div className={splitClasses}>
              ...
              <div className="split-item">
                <div className="split-item-content center-content-mobile reveal-from-left" data-reveal-container=".split-item">
                  ...
                  <p className="m-0">
               DeStake is a Liquid Staking DAO powered by STAKE, the native governance token, which acts as a built-in incentive system designed to drive user participation across staking networks and provide liquidity for the synthetic trading pairs. Simply deposit your synthetic assets as liquidity in the associated uniswap pool and begin receiving STAKE tokens automatically.
